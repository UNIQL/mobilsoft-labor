...
import com.mobilsoftlab.uniql.restaurantapp.network.NetworkModule;
...
public class MockNetworkModule {
    ...
    @Provides
    @Singleton
    public RestaurantApi provideAuthApi(Retrofit retrofit) {
        return networkModule.provideARestaurantApi(retrofit);
    }
